...
export class CategoryService {
    ...
    load(params) {
        return new Promise(resolve => {
            ...
            this.reqhttp.get(this.config.setUrl('GET', '/wp-json/wc/v2/products?', params), {}, {})
            .then(data => {
    ...
    loadMore(filter) {
        return new Promise(resolve => {
            this.reqhttp.clearCookies();
            this.reqhttp.get(this.config.setUrl('GET', '/wp-json/wc/v2/products?', filter), {}, {})
                .then(data => {
                    this.products = JSON.parse(data.data);
                    resolve(this.products);
                });
    ...
    getAttributes() {
        ...
        return new Promise(resolve => {
            this.reqhttp.clearCookies();
            this.reqhttp.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/attributes?', false), {}, {}).then(data => {
    ...
    attributeTerms(id) {
        ...
        return new Promise(resolve => {
            this.reqhttp.clearCookies();
            this.reqhttp.get(this.config.setUrl('GET', '/wp-json/wc/v2/products/attributes/' + id + '/terms?', false), {}, {}).then(data => {
